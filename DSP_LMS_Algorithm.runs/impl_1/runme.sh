...
HD_PWD='C:/Users/LorenzoLLC/DSP_project/DSP_LMS_Algorithm/DSP_LMS_Algorithm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADCInterface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADCInterface.tcl -notrace
