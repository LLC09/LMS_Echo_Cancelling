...
namespace eval ::optrace {
  variable script "C:/Users/LorenzoLLC/DSP_project/DSP_LMS_Algorithm/DSP_LMS_Algorithm.runs/impl_1/XADCInterface.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Users/LorenzoLLC/DSP_project/DSP_LMS_Algorithm/DSP_LMS_Algorithm.runs/synth_1/XADCInterface.dcp
...
OPTRACE "link_design" START { }
  link_design -top XADCInterface -part xa7a15tcpg236-1I
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force XADCInterface_opt.dcp
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force XADCInterface_placed.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force XADCInterface_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force XADCInterface_routed.dcp
...
if {$rc} {
  write_checkpoint -force XADCInterface_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  catch { write_mem_info -force -no_partial_mmi XADCInterface.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force XADCInterface.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force XADCInterface}
  catch {file copy -force XADCInterface.ltx debug_nets.ltx}
